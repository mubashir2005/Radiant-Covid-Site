...
function Header() {
  ...
  return (
    <header
      className={
        "border border-gray-200 py-4 px-1 md:px-8 flex flex-row items-center dark:bg-black dark:bg-opacity-30 bg-opacity-40 dark:text-white dark:border-0 header"
      }
    >
      <p
        className={
