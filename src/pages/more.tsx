  ...
  return (
    <div className={"more"}>
      ...
      <div className={"more__links"}>
        <a
          href={"https://shortnner.tech/QnsDuT_Y6"}
          target={"_blank"}
        ...
        <br />
        <a
          href={"https://shortnner.tech/gmXKr2ABm"}
          target={"_blank"}
          className={"more__link"}
        >
        ...
        <br />
        <a
          href="https://shortnner.tech/2fcQ23i01"
          className={"more__link"}
          target={"_blank"}
        >
          <strong>MOHFW</strong>
        ...
        <br />
        <a
          href="https://shortnner.tech/Tw4D8BI7a"
          className={"more__link"}
          target={"_blank"}
        >
        ...
        <br />
        <a
          href="https://qrgo.page.link/wtmHD"
          className={"more__link"}
          target={"_blank"}
        >
        ...
        <br/>
        <br/>
        <a href="https://covid19health.bihar.gov.in/DailyDashboard/BedsOccupied">
          <strong>Bihar ICU beds tracking</strong>
        </a>
        <br />
        <br />
        <br />
